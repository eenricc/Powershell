...
$ticket = ""
$logFile = "C:\scripts\BajaUsuarios\log_test.csv"
$Admin = $(whoami)
$loop = $true
$TryUser = $true
#Alliberem sessions O365
...
#CONNEXIÓ O365 
Connect-ExchangeOnline -ShowBanner:$false #-ConnectionUri "https://outlook.office365.com/powershell-liveid/"
...
While ($loop = $true){
    ...
    If(($autoreplay -eq "Y") -or ($autoreplay -eq "y")){
        ...
        #Treu la llicencia excepte la que tenia
        #ES CORRECTE?
